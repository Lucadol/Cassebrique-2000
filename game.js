...
function create() {
    ...
    let balle = this.physics.add.sprite(900, 700, 'mon_sprite', '58-Breakout-Tiles.png');
    balle.setScale(0.4);
    ...
    let raquette = this.physics.add.sprite(900, 800, 'mon_sprite', '56-Breakout-Tiles.png');
